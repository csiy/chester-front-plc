  ...
  <v-data-table
    ...
    <template v-slot:top>
      <v-row align="center" justify="start">
        ...
        <v-btn @click="printPDFItems" small color="success" :disabled="selected.length===0">
    ...
    <template v-slot:item.action="{ item }">
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on }">
          <v-btn v-on="on" icon color="blue-grey lighten-1" class="mr-2" @click="printPDFItem(item)">
